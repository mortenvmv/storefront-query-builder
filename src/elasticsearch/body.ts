          ...
          if (field !== 'price') {
            ...
            if (this.config.products && this.config.products.aggregate) {
              if (this.config.products.aggregate.maxPrice) {
                this.queryChain.aggregation('max', 'lowestPrice')
              }
              if (this.config.products.aggregate.minPrice) {
                this.queryChain.aggregation('min', 'lowestPrice')
              }
              if (this.config.products.aggregate.maxCostPrice) {
                this.queryChain.aggregation('max', 'cost_price')
              }
